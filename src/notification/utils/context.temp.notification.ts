...
import { otpVerificationEmail } from "../templates/otpVerificationEmail.temp.notification.js";
...
export const templateContexts: Record<keyof TemplatePayloadType, (value: any) => string> = {
  ...
  otpVerification: (data: TemplatePayloadType['otpVerification']) => otpVerificationEmail(data.firstName, data.otp, data.expiryMinutes)
};